...
def nature_cnn(unscaled_images, **conv_kwargs):
    ...
    activ = tf.nn.relu
    h1 = activ(conv(scaled_images, 'c1', nf=3, rf=8, stride=4, init_scale=np.sqrt(2), **conv_kwargs))
    print(h1.shape)
    h2 = activ(conv(h1, 'c2', nf=6, rf=8, stride=4, init_scale=np.sqrt(2), **conv_kwargs))
    print(h2.shape)
    h3 = conv_to_fc(h2)
    print(h3.shape)
