...
def search_routing_in_wuhan(visual=False):
    ...
    if visual:
        ...
        line.style.polystyle.color = simplekml.Color.chocolate
        line.style.linestyle.color = simplekml.Color.chocolate
...
def main_step_9_10():
    ...
    for i, e in enumerate(info):
        ...
        print(conflict_ac[0] in conflicts[0].id, conflict_ac[1] in conflicts[0].id)
        ...
        print(main_c, conflict_ac[0] in main_c.id, conflict_ac[1] in main_c.id)
...
if __name__ == '__main__':
    search_routing_in_wuhan(visual=True)
    # main_step_1_to_8()
    # main_step_9_10()
    pass
